...
CFloatParameter AMPLITUDE("AMPLITUDE", CBaseParameter::RW, 0.0, 0, 0.0, 1);
CIntParameter WAVEFORM("WAVEFORM", CBaseParameter::RW, 0, 0, 0, 8);
CIntParameter PHASE("PHASE", CBaseParameter::RW, 0, 0, 0, 360);
CFloatParameter OFFSET("OFFSET", CBaseParameter::RW, 0, 0, -2, 2);
...
CFloatParameter AMPLITUDE1("AMPLITUDE1", CBaseParameter::RW, 0.0, 0, 0.0, 1);
CIntParameter WAVEFORM1("WAVEFORM1", CBaseParameter::RW, 0, 0, 0, 9);
CIntParameter PHASE1("PHASE1", CBaseParameter::RW, 0, 0, 0, 360);
CFloatParameter OFFSET1("OFFSET1", CBaseParameter::RW, 0, 0, -2, 2);
...
void set_generator_config()
{
    ...
    switch (WAVEFORM.Value()) {
        ...
        case 5: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_DC); break;
        case 6: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_DC_NEG); break;
        case 7: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_PWM); break;
        case 8: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_ARBITRARY); break;
    }
