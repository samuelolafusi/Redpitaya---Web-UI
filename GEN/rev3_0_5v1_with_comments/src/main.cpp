...
CFloatParameter AMPLITUDE("AMPLITUDE", CBaseParameter::RW, 0.0, 0, 0.0, 1);        // Amplitude: 0-1 V, starts at 0
CIntParameter WAVEFORM("WAVEFORM", CBaseParameter::RW, 0, 0, 0, 8);                 // Waveform: 0-8 types, starts at 0
CIntParameter PHASE("PHASE", CBaseParameter::RW, 0, 0, 0, 360);                     // Phase: 0-360 degrees, starts at 0
CFloatParameter OFFSET("OFFSET", CBaseParameter::RW, 0, 0, -2, 2);                  // Offset: -2 to 2 V, starts at 0
...
CFloatParameter AMPLITUDE1("AMPLITUDE1", CBaseParameter::RW, 0.0, 0, 0.0, 1);      // Amplitude: 0-1 V, starts at 0
CIntParameter WAVEFORM1("WAVEFORM1", CBaseParameter::RW, 0, 0, 0, 9);              // Waveform: 0-9 types, starts at 0
CIntParameter PHASE1("PHASE1", CBaseParameter::RW, 0, 0, 0, 360);                   // Phase: 0-360 degrees, starts at 0
CFloatParameter OFFSET1("OFFSET1", CBaseParameter::RW, 0, 0, -2, 2);               // Offset: -2 to 2 V, starts at 0
...
void set_generator_config() // Set up the signal generator for both channels
{
    ...
    switch (WAVEFORM.Value()) { // Choose Channel 1 waveform based on value
        ...
        case 5: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_DC); break;        // 5 = DC positive
        case 6: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_DC_NEG); break;    // 6 = DC negative
        case 7: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_PWM); break;       // 7 = PWM
        case 8: rp_GenWaveform(RP_CH_1, RP_WAVEFORM_ARBITRARY); break; // 8 = Arbitrary (noise)
    }
    ...
    switch (WAVEFORM1.Value()) { // Choose Channel 2 waveform
        ...
        case 5: rp_GenWaveform(RP_CH_2, RP_WAVEFORM_DC); break;
        case 6: rp_GenWaveform(RP_CH_2, RP_WAVEFORM_DC_NEG); break;
        case 7: rp_GenWaveform(RP_CH_2, RP_WAVEFORM_PWM); break;
        case 8: rp_GenWaveform(RP_CH_2, RP_WAVEFORM_ARBITRARY); break;
    }
}
