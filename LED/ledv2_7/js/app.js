...
$(function() {
    ...
    $('.led_state').click(function() {
        ...
        if (APP.led_states[ledIndex]) {
            statusSpan.text('LED ' + ledIndex + ' is off').removeClass('led_on').addClass('led_off');
            APP.led_states[ledIndex] = false;
        } else {
            statusSpan.text('LED ' + ledIndex + ' is on').removeClass('led_off').addClass('led_on');
            APP.led_states[ledIndex] = true;
        }
        var local = {};
        local['LED' + ledIndex + '_STATE'] = { value: APP.led_states[ledIndex] };
